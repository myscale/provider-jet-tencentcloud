...
import (
	"context"
	v1alpha1 "github.com/crossplane-contrib/provider-jet-tencentcloud/apis/role/v1alpha1"
...
func (mg *RolePolicyAttachment) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		Reference:    mg.Spec.ForProvider.RoleIdRefs,
	...
	mg.Spec.ForProvider.RoleIdRefs = rsp.ResolvedReference
